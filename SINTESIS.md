...
| d) | Analiza casos de uso y escenarios en los que DevOps aporta beneficios. | 0,41 |
| e) | Explica la importancia de la comunicación y colaboración entre desarrollo y operaciones en DevOps. | 0,41 |
| f) | Expone buenas prácticas en la adopción de DevOps dentro de una empresa. | 0,41 |
| g) | Relaciona DevOps con otros paradigmas como Agile y Site Reliability Engineering (SRE). | 0,41 |
...
| d) | Utiliza webhooks para integrar control de versiones con herramientas de automatización. | 1,90 |
| e) | Documenta adecuadamente commits y versiones siguiendo buenas prácticas. | 1,90 |
| f) | Resuelve conflictos en entornos de trabajo colaborativo utilizando herramientas de merge. | 1,90 |
...
| d) | Implementa pruebas automatizadas en pipelines. | 2,44 |
| e) | Identifica errores y optimiza la eficiencia de pipelines de CI/CD. | 2,44 |
| f) | Explica estrategias de despliegue seguro como Blue-Green Deployment y Canary Releases. | 2,44 |
| g) | Aplica la gestión de credenciales y variables de entorno en pipelines. | 2,44 |
...
| d) | Explica la arquitectura de Kubernetes y sus componentes principales. | 2,44 |
| e) | Despliega aplicaciones en un clúster de Kubernetes. | 2,44 |
| f) | Gestiona volúmenes y redes en entornos de contenedores. | 2,44 |
| g) | Implementa políticas de seguridad en contenedores. | 2,44 |
...
| d) | Implementa entornos reproducibles con Vagrant y Docker. | 2,38 |
| e) | Explica buenas prácticas en la automatización de infraestructura. | 2,38 |
| f) | Usa sistemas de gestión de configuraciones para control de cambios. | 2,38 |
...
| d) | Diseña alertas y notificaciones automatizadas en sistemas de monitorización. | 1,90 |
| e) | Implementa dashboards de observabilidad para análisis de rendimiento. | 1,90 |
| f) | Explica la relación entre monitorización, seguridad y mantenimiento preventivo. | 1,90 |
...
| d) | Se ha trabajado en equipo, aplicando metodologías colaborativas propias de entornos DevOps. | 5,14 |
| e) | Se ha documentado el proyecto final, incluyendo procedimientos, configuraciones y justificación técnica de las decisiones tomadas. | 5,14 |

---

## Criterios de calificación

La calificación final del módulo se obtiene mediante la **media ponderada de los resultados de aprendizaje (RA)**, tomando como base su peso relativo en el total de horas (105 h).  
